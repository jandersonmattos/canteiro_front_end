...
import { Reminder, DraftReminder, DAYS_OF_WEEK, getRecurrenceLabel, emptyDraft } from '@/lib/reminders/types'

interface RemindersContentProps {
  projectId: string
}

export function RemindersContent({ projectId }: RemindersContentProps) {
