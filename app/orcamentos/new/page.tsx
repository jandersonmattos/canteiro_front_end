...
export default function NewBudgetPage() {
  ...
  const obraOptions = [
    {
      label: "Condomínio Reserva do Lago",
      value: "1",
    },
    {
      label: "Residencial Monte Alto",
      value: "2",
    },
    {
      label: "Edifício Prime Tower",
      value: "3",
    },
  ];
  ...
  function getDefaultBdiPercentage(serviceId: string) {
    return selectedServices[serviceId]?.bdiPercentage ?? 25;
  }
  ...
  async function handleSaveBudget() {
    ...
    const selectedObraLabel =
      obraOptions.find((option) => option.value === form.obra)?.label || "";
    ...
    try {
      ...
      const budgetId = responseData?.id;
      toast.success("Orçamento salvo com sucesso");
      
      if (budgetId) {
        router.push(`/orcamentos/edit/${budgetId}`);
      } else {
          ...
          <div className="px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h1 className="text-4xl font-bold mb-2">Novo orçamento</h1>

                  <p className="text-zinc-400">
                    Fluxo inteligente de composição orçamentária
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl font-bold mb-4">
                  Monte seu orçamento em 3 etapas
                </h2>

                <p className="text-zinc-400 max-w-3xl leading-relaxed">
                  Defina os dados iniciais, escolha a origem dos serviços e
                  depois monte toda a composição financeira do orçamento.
                </p>
              </div>
            </div>
              ...
              "
                            ...
                            <div>
                              ...
                              <p className="text-sm text-zinc-400 leading-relaxed">
                                ...
                                selecionada na etapa anterior. Ao integrar com o
                                backend, esta lista será carregada
                                dinamicamente.
                              </p>
                            </div>
                          </div>
